// src/components/DocumentPreviewModal.tsx - COMPLETE VERSION WITH PORTAL FIX
import React, { useEffect, useRef, useState, useMemo, useCallback } from 'react';
import { createPortal } from 'react-dom'; // CRITICAL: Portal import
...
const DocumentPreviewModal: React.FC<DocumentPreviewModalProps> = ({ proposal, onClose }) => {
  ...
  // Effect to control body scrolling and mounting
  useEffect(() => {
    setMounted(true);
  ...
  if (!proposal) {
    ...
    return mounted ? createPortal(errorModal, document.body) : null;
  }
  ...
  // CRITICAL: Use React Portal to render modal at body level
  return (
    <>
